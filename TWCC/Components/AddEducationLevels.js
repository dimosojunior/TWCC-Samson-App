...
export default function AddEducationLevels({ navigation }) {
  ...
  const handleSubmit = async () => {
    ...
    if (userToken) {
      const formData = new FormData();
        ...
        showAlertFunction('Please fill in Education level name');
        return;
    }
   ...
   axios.post(EndPoint + `/AddEducationLevelsView/`, formData, {
        headers: {
        ...
        setPending(false);
        showAlertFunction("New education level is added successfull");
        //console.log("Well");
